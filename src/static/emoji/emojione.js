...
(function(ns) {
    ...
    for (emoji in ns.emojioneList) {
        ...
        for (var i = 0; i < ns.emojioneList[emoji].shortnames.length; i++) {
            tmpShortNames.push(
                ns.emojioneList[emoji].shortnames[i].replace(/[+]/g, '\\$&')
            );
        }
    }
    ...
    ns.imagePathPNG =
        'https://cdn.jsdelivr.net/emojione/assets/' + ns.emojiVersion + '/png/';
    ...
    ns.shortnameToImage = function(str) {
        ...
        str = str.replace(ns.regShortNames, function(shortname) {
            if (
                typeof shortname === 'undefined' ||
                shortname === '' ||
                ns.shortnames.indexOf(shortname) === -1
            ) {
                // if the shortname doesnt exist just return the entire match
                return shortname;
            } else {
                ...
                if (!ns.emojioneList[shortname]) {
                    for (var emoji in ns.emojioneList) {
                        if (
                            ...
                            continue;
                        if (
                            ns.emojioneList[emoji].shortnames.indexOf(
                                shortname
                            ) === -1
                        )
                            continue;
                ...
                size =
                    ns.spriteSize == '32' || ns.spriteSize == '64'
                        ? ns.spriteSize
                        : '32';
