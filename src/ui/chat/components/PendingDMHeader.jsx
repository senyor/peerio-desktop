        ...
        return (
            <div className="pending-dm-header">
                ...
                {this.props.isNewUser
                    ? <T k="title_newUserDmInviteHeading" className="main-text">{{ contactName: c.fullName }}</T>
                    : <div className="main-text">
                        <T k="title_goodNews" /><br />
                ...
                {this.props.isNewUser
                    ? null
                    : <T
                        k={chat.isAutoImport ? 'title_userInAddressBook' : 'title_invitedUserViaEmail'}
