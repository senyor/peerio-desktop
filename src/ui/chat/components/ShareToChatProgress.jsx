        ...
        return (
            <div className="share-to-chat-progress">
                <div className="info">
                    ...
                    <div className="text">
                        {item.isFolder
                            ...
                            : queued
                                ? <T k="title_queuedFiles" tag="span">{{ name: item.name, remaining: queued }}</T>
                                : <T k="title_uploadingAndEncrypting" tag="span">{{ name: item.name }}</T>
                        }
                    </div>
                ...
                {queued
                    ...
                    : <ProgressBar type="linear" mode="determinate" value={progress || 0} max={progressMax} />
                }
