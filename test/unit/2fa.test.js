...
describe('2fa helper', () => {
    [
        ...
        { code: 123456, expected: { readyToSubmit: true, isBackupCode: false } },
        { code: '1234', expected: { readyToSubmit: false, isBackupCode: false } },
        { code: '123456', expected: { readyToSubmit: true, isBackupCode: false } },
        { code: '   12 3456 ', expected: { readyToSubmit: true, isBackupCode: false } },
        { code: '12-34', expected: { readyToSubmit: false, isBackupCode: true } },
        { code: '12345678', expected: { readyToSubmit: true, isBackupCode: false } },
        { code: '1234-1234-1234-1234', expected: { readyToSubmit: true, isBackupCode: true } },
        { code: '123 4-1 234-1234 - 12 34', expected: { readyToSubmit: true, isBackupCode: true } },
